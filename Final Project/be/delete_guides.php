...
if (isset($_POST['confirm_delete']) && $_POST['confirm_delete'] === 'yes' && isset($_POST['id'])) {
    ...
    $sql = "DELETE FROM GUIDE WHERE UserID = ?";
    ...
    if ($stmt->execute()) {
        ...
        $_SESSION['success_msg'] = "Guide deleted successfully.";
    } else {
        $_SESSION['error_msg'] = "Error deleting guide.";
    }
    ...
    <div class="login-box">
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <b>Are you sure you want to delete this guide?</b>
            </div>
            <div class="card-body">
